...
<jsp:useBean id="Rolbean" class="com.sunilos.p4.bean.RoleBean"
					...
					<thead class="table-light">
						...
						<tr>
							...
							<th width="40"><input type="checkbox"
								onclick="document.querySelectorAll('input[name=ids]:not(:disabled)').forEach(c => c.checked = this.checked)">
