...
<%@page import="com.sunilos.p4.bean.DeliveryBean"%>
...
<jsp:useBean id="bean"
    class="com.sunilos.p4.bean.DeliveryBean"
    scope="request">
</jsp:useBean>
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <div
            ...
            <h5 class="mb-0 fw-bold">
                <i class="bi bi-cart me-2"></i> Delivery List
            </h5>

            <div class="d-flex gap-2">

                <!-- PDF -->
                <a href="<%=ORSView.DELIVERY_REPORT_CTL%>"
                   target="_blank"
                ...
                <!-- DOC -->
                <a href="<%=ORSView.DELIVERY_REPORT_CTL%>?type=doc"
                   target="_blank"
        ...
        <!-- Form -->
        <form action="<%=ORSView.DELIVERY_LIST_CTL%>" method="POST">
                ...
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        while (it.hasNext()) {
                            ...
                            DeliveryBean deliveryBean = it.next();
                        %>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="DeliveryCtl?id=<%=deliveryBean.getId()%>"
